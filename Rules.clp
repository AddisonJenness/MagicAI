...
(deftemplate Order       (declare (from-class Card)))

(deftemplate OrderItem   (declare (from-class Player)))

(deftemplate CatalogItem (declare (from-class GameLogic)))

(deftemplate Customer    (declare (from-class App)))
